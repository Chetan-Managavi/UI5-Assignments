		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Northwind",
									"targetURL": "#comnorthwindnorthwindorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnorthwindnorthwindorders-display": {
								"semanticObject": "comnorthwindnorthwindorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.northwind.northwindorders",
									"url": sap.ui.require.toUrl("com/northwind/northwindorders")
								}
							}
						}
					}
