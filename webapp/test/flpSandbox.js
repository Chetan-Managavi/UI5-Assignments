		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Northwind",
									"targetURL": "#comnorthwindnorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnorthwindnorthwind-display": {
								"semanticObject": "comnorthwindnorthwind",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.northwind.northwind",
									"url": sap.ui.require.toUrl("com/northwind/northwind")
								}
							}
						}
					}
